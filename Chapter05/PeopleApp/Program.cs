...
//Fruit fruitNamed = bob.GetNameFruit();

//Console.WriteLine(fruitNamed);

//(string name, int number) namedFields = bob.GetNameFruit();

//WriteLine($"{namedFields.name}, {namedFields.number}");

//(string name, int number) = bob.GetNameFruit();
...
//Console.WriteLine(bob.FavoriteAncientWonder);
